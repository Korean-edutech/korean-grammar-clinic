    ...
    if st.session_state.user_email is None:
        ...
        if final_prompt:
            ...
            if not api_key:
                ...
                5. 모든 문법 답변엔 반드시 한국어 예문을 정확히 2개씩 덧붙이세요. 그러나 질문자가 3개가 아니라 2개를 알려달라고 하면 2개, 4개를 알려달라고 하면 4개를 알려주세요. 
                ...
                8. 💡 답변의 맨 마지막에는 반드시 '💡 다음은 무엇을 알아볼까요?'라는 소제목을 달고, 현재 설명한 문법과 직결된 심화 개념(예: 불규칙 활용, 예외 사항)을 제시하세요. 질문자가 물어보기 전까지 다른 문법에 대해서는 언급하지 마세요.
