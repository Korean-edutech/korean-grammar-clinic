...
ui_texts = {
    "한국어": {
        ...
        "btn_level1": "🌱 1단계: 기본 개념과 형태 규칙",
        "prompt_level1": "'{room}' 문법 문서에서 [1단계]에 해당하는 기본 개념과 형태 규칙을 설명해 줘.",
        "btn_level2": "🌿 2단계: 핵심 사용법과 특징",
        "prompt_level2": "'{room}' 문법 문서에서 [2단계]에 해당하는 핵심 사용법이나 특징(대조, 뉘앙스, 불규칙 등)을 설명해 줘.",
        "btn_level3": "🌳 3단계: 심화 표현 및 주의할 점",
        "prompt_level3": "'{room}' 문법 문서에서 [3단계]에 해당하는 심화 표현이나 주의해야 할 점(보격 조사, 동음이의어 등)을 설명해 줘."
    },
    "English": {
        ...
        "btn_level1": "🌱 Step 1: Basic Concepts & Form Rules",
        "prompt_level1": "Please explain the [Step 1] basic concepts and form rules from the '{room}' grammar document.",
        "btn_level2": "🌿 Step 2: Core Usage & Features",
        "prompt_level2": "Please explain the [Step 2] core usage or features (e.g., contrasts, nuances, irregulars) from the '{room}' grammar document.",
        "btn_level3": "🌳 Step 3: Advanced Expressions & Tips",
        "prompt_level3": "Please explain the [Step 3] advanced expressions or points to note (e.g., complements, homonyms) from the '{room}' grammar document."
    },
    "日本語": {
        ...
        "btn_level1": "🌱 第1段階：基本概念と形態規則",
        "prompt_level1": "'{room}' の文法ドキュメントから、[1段階] に該当する基本概念と形態規則を説明してください。",
        "btn_level2": "🌿 第2段階：核心的な使い方と特徴",
        "prompt_level2": "'{room}' の文法ドキュメントから、[2段階] に該当する核心的な使い方や特徴（対比、ニュアンス、不規則など）を説明してください。",
        "btn_level3": "🌳 第3段階：深化表現と注意点",
        "prompt_level3": "'{room}' の文法ドキュメントから、[3段階] に該当する深化表現や注意すべき点（補格助詞、同音異義語など）を説明してください。"
    },
    "中文": {
        ...
        "btn_level1": "🌱 第1阶段：基本概念与形态规则",
        "prompt_level1": "请解释 '{room}' 语法文件中 [1阶段] 的基本概念和形态规则。",
        "btn_level2": "🌿 第2阶段：核心用法与特征",
        "prompt_level2": "请解释 '{room}' 语法文件中 [2阶段] 的核心用法或特征（如对比、语感、不规则等）。",
        "btn_level3": "🌳 第3阶段：进阶表达与注意事项",
        "prompt_level3": "请解释 '{room}' 语法文件中 [3阶段] 的进阶表达或注意事项（如补格助词、同音异义词等）。"
    },
    "Español": {
        ...
        "select_lang": "Seleccionar idioma", "delete_btn": "🗑️ Elimina",
        ...
        "btn_level1": "🌱 Paso 1: Conceptos Básicos y Reglas de Forma",
        "prompt_level1": "Por favor, explica los conceptos básicos y reglas de forma del [Paso 1] del documento de gramática '{room}'.",
        "btn_level2": "🌿 Paso 2: Uso Principal y Características",
        "prompt_level2": "Por favor, explica el uso principal o características (ej. contrastes, matices, irregulares) del [Paso 2] del documento de gramática '{room}'.",
        "btn_level3": "🌳 Paso 3: Expresiones Avanzadas y Consejos",
        "prompt_level3": "Por favor, explica las expresiones avanzadas o puntos a tener en cuenta del [Paso 3] del documento de gramática '{room}'."
    },
    "Tiếng Việt": {
        ...
        "btn_level1": "🌱 Bước 1: Khái niệm cơ bản & Quy tắc hình thái",
        "prompt_level1": "Vui lòng giải thích khái niệm cơ bản và quy tắc hình thái của [Bước 1] trong tài liệu ngữ pháp '{room}'.",
        "btn_level2": "🌿 Bước 2: Cách sử dụng chính & Đặc điểm",
        "prompt_level2": "Vui lòng giải thích cách sử dụng chính hoặc đặc điểm (ví dụ: sự tương phản, sắc thái, bất quy tắc) của [Bước 2] trong tài liệu ngữ pháp '{room}'.",
        "btn_level3": "🌳 Bước 3: Biểu hiện nâng cao & Lưu ý",
        "prompt_level3": "Vui lòng giải thích các biểu hiện nâng cao hoặc những điểm cần lưu ý của [Bước 3] trong tài liệu ngữ pháp '{room}'."
    },
    "Français": {
        ...
        "btn_level1": "🌱 Étape 1 : Concepts de base et Règles de forme",
        "prompt_level1": "Veuillez expliquer les concepts de base et les règles de forme de l'[Étape 1] du document de grammaire '{room}'.",
        "btn_level2": "🌿 Étape 2 : Utilisation principale et Caractéristiques",
        "prompt_level2": "Veuillez expliquer l'utilisation principale ou les caractéristiques (ex. contrastes, nuances, irréguliers) de l'[Étape 2] du document de grammaire '{room}'.",
        "btn_level3": "🌳 Étape 3 : Expressions Avancées et Conseils",
        "prompt_level3": "Veuillez expliquer les expressions avancées ou les points à retenir de l'[Étape 3] du document de grammaire '{room}'."
    },
    "हिन्दी": {
        ...
        "btn_level1": "🌱 चरण 1: मूल अवधारणाएँ और रूप नियम",
        "prompt_level1": "कृपया '{room}' व्याकरण दस्तावेज़ से [चरण 1] मूल अवधारणाओं और रूप नियमों की व्याख्या करें।",
        "btn_level2": "🌿 चरण 2: मुख्य उपयोग और विशेषताएँ",
        "prompt_level2": "कृपया '{room}' व्याकरण दस्तावेज़ से [चरण 2] मुख्य उपयोग या विशेषताओं (जैसे कंट्रास्ट, सूक्ष्मता, अनियमितता) की व्याख्या करें।",
        "btn_level3": "🌳 चरण 3: उन्नत भाव और सुझाव",
        "prompt_level3": "कृपया '{room}' व्याकरण दस्तावेज़ से [चरण 3] उन्नत भाव या ध्यान देने योग्य बिंदुओं की व्याख्या करें।"
    },
    "Italiano": {
        ...
        "btn_level1": "🌱 Fase 1: Concetti base e Regole di forma",
        "prompt_level1": "Spiega i concetti di base e le regole di forma della [Fase 1] dal documento di grammatica '{room}'.",
        "btn_level2": "🌿 Fase 2: Uso Principale e Caratteristiche",
        "prompt_level2": "Spiega l'uso principale o le caratteristiche (es. contrasti, sfumature, irregolari) della [Fase 2] dal documento di grammatica '{room}'.",
        "btn_level3": "🌳 Fase 3: Espressioni Avanzate e Consigli",
        "prompt_level3": "Spiega le espressioni avanzate o i punti da notare della [Fase 3] dal documento di grammatica '{room}'."
    }
}
...
# 4. 🚪 문법 클리닉 챗봇 엔진 로직
    ...
    # 텍스트 파일 로드
    file_path = f"grammar_data/{selected_meta_word}.txt"
    with open(file_path, "r", encoding="utf-8") as file:
        target_rules = file.read()

    # ====================================================================
    # 🎯 범용 가이드 및 3단계 학습 버튼 (모든 방 공통)
    # ====================================================================
    ...
    if st.session_state.user_email is None:
        ...
        if final_prompt:
            ...
            if not api_key:
                ...
                [대화 행동 지침 - 최우선 준수 사항]
                0. {lang_rule}
                1. 간결성: 답변은 3~4문장 이내로 아주 핵심만 짧게 전달하세요. 한 번에 모든 예외 규칙이나 예문을 설명하지 마세요.
                2 출력 언어: 반드시 학습자의 선택 언어({current_lang})로 번역하여 대답하세요.
                3. 답변은 잡다한 설명 없이 간단하게 질문에 대한 핵심 내용만 명확히 하세요.
                4. 모든 문법 답변엔 반드시 한국어 예문을 정확히 3개씩 덧붙이세요. 그러나 질문자가 3개가 아니라 특정 개수를 언급하면 그만큼 알려주세요. 2개를 알려달라고 하면 2개, 4개를 알려달라고 하면 4개를 알려주세요. 
                5. 🚨 예문 난이도 통제: 예문의 어휘와 문장 구조는 해당 문법을 배우는 학습자의 수준에 철저히 맞춰야 합니다. 
                - '아요/어요'와 같은 초급 기초 문법을 설명할 때는 반드시 TOPIK 1~2급 수준의 아주 쉬운 기본 어휘(예: 학교, 밥, 친구, 가다, 먹다 등)만 사용하세요.
                - 문장 길이는 최대한 짧게 단문으로 유지하고, 복잡한 접속사나 어려운 한자어, 추상적인 개념은 절대 사용하지 마세요.
                - 예문을 출력하기 전, 초보자가 사전을 찾지 않고도 직관적으로 이해할 수 있는 난이도인지 스스로 한 번 더 검토하세요. 각 예문은 줄머리 기호를 넣어 한 줄에 하나씩 보기 좋게 출력하세요.
                6. 사용자가 본격적으로 문법에 대해 질문하거나 대화를 시도할 때만 아래 관리자가 등록한 교안/문법 규칙을 바탕으로 설명하세요.
                7. 가독성: 설명을 줄글로 길게 쓰지 말고, 글머리 기호(-, *)를 사용해 깔끔하게 정리하세요.
                8. 과정 설명: 예시를 들 때는 결과만 보여주지 말고, 반드시 변화 과정(예: 가다 + 아요 -> 가요)을 공식을 쓰듯 명확히 보여주세요.
                9. 눈높이 맞춤: 학습자가 아직 배우지 않은 개념이나 예외 규칙을 미리 던져서 혼란스럽게 하지 마세요.
                10. 친절한 마무리: 설명이 끝난 후에는 배운 내용을 확인하는 짧은 질문이나 격려의 말로 마무리하세요.
                11. 💡 꼬리 질문 유도 (중복 출력 절대 금지): 답변의 맨 마지막에는 반드시 '{current_lang}'로 번역된 "💡 다음은 무엇을 알아볼까요?" 형식의 소제목을 달아주세요. 그리고 현재 설명한 문법과 직결된 심화 개념(예: 불규칙 활용, 예외 사항)을 제시하는 꼬리질문 내용 역시 반드시 '{current_lang}'로만 작성하세요. (질문자가 묻기 전까지 다른 문법 언급 금지, 소제목 아래 빈칸 두지 말 것)
                    나쁜 예: (아요/어요 설명 후) "은/는에 대해서도 알아보시겠어요?" 또는 "'습니다/ㅂ니다'와 어떤 뉘앙스 차이가 있는지 비교해 드릴까요?"
                    좋은 예: "이해하셨나요? '아요/어요'를 쓸 때 주의해야 할 'ㅂ 불규칙'에 대해서도 알아볼까요?"
                12. 채팅방에서 다루는 문법 이외의 것을 물어보는 경우에는 아주 간략하게 개념에 대해서만 설명하고 넘어가세요.
