...
# 각 언어별 UI 사전 (💡 'grammar_topics' 다국어 추가!)
ui_texts = {
    "English": {
    ...
    "Español": {
        ...
        "grammar_topics": "📚 Temas de Gramática",
...
# 💡 [핵심 수정 1] 클리닉 메뉴일 때만 네비게이션 바로 아래에 문법 방 목록을 그립니다.
selected_display_name = None
if page_mode == t["menu_clinic"]:
    st.sidebar.divider()
    st.sidebar.subheader(t["grammar_topics"]) # 다국어 적용
...
# 💡 [핵심 수정 2] 관리자 모드를 사이드바 그리기 '맨 마지막'으로 이동하여 최하단에 고정
