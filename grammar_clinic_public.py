    ...
    if st.session_state.user_email is None:
        ...
        if final_prompt:
            ...
            if not api_key:
                ...
                3. 출력 언어: 반드시 학습자의 선택 언어({selected_lang_code})로 번역하여 대답하세요.
                ...
                8. 💡 답변의 맨 마지막에는 반드시 '**💡 더 알아보면 좋은 개념**'이라는 소제목을 달고, 현재 설명한 내용과 연관된 심화 문법이나 비교해서 알아두면 좋은 다른 문법 1~2가지를 짧게 추천하여 추가 학습을 유도하세요.
